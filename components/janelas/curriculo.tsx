...
import CurriculoConteudo from "../conteudo/curriculoConteudo";
...
export default function Curriculo({ onFechar, isOpen }: JanelaProps) {
  ...
  useEffect(() => {
    const x = (window.innerWidth - larguraJanela) / 1.6;
    const y = (window.innerHeight - alturaJanela) / 1.6;
      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-center gap-1 cursor-pointer text-white">
            <p className="pl-4">Currículo.txt</p>
            <Image
              alt="monitor"
