...
import Falecomigo from "../conteudo/falecomigo";
...
export default function Contato({ onFechar, isOpen, aoClicar, zIndex }: JanelaProps) {
  ...
  useEffect(() => {
    const x = (window.innerWidth - larguraJanela) / 1.9;
    const y = (window.innerHeight - alturaJanela) / 1.9;
      ...
      >
        ...
        <div className="flex-1 p-4 h-full overflow-y-auto">
          ...
          <footer className="flex justify-center items-center">
            <section className="flex flex-col w-full text-white pt-2 pb-1">
