...
export default function Janela({ onFechar, isOpen }: JanelaProps) {
  ...
  return (
    ...
    >
      ...
      <div
        /* Tamanho da janela */
        className="w-7xl h-220 absolute shadow-2xl overflow-hidden 
          janela-scroll
      ...
      >
        ...
        <div className="flex flex-col h-full overflow-y-auto">
          <div className="flex justify-center gap-7 ">
            ...
            <div className="flex justify-start flex-col text-white pt-10">
              ...
              <p className="pt-7 w-xl font-light">
                Fique à vontade para abrir arquivos, explorar pastas e conhecer
                um pouco mais sobre minha forma de pensar, projetar e construir
                produtos digitais.
              </p>
              {/* botões */}
          ...
          <div className="flex justify-center p-10">
            <div className="w-full h-200 bg-red-800 "></div>
          </div>
        </div>
      </div>
    </div>
